...
=begin
class DashboardTest < Frontkiq::Test

  describe 'frontkiq dashboard' do
    ...
    feature 'dashboard' do
      scenario 'fails' do
        visit '/frontkiq'
        page.must_have_content "Meshuggena"
      end
    end
    ...
    it 'can show user defined tab' do
      begin
        # Frontkiq::Web.tabs['Custom Tab'] = '/custom'

        get '/'
        assert_match 'Custom Tab', last_response.body

      ensure
        # Frontkiq::Web.tabs.delete 'Custom Tab'
      end
    end
    ...
    # Frontkiq::Web.settings.locales << File.join(File.dirname(__FILE__), "fixtures")
    it 'can show user defined tab with custom locales' do
      skip("later!")

      begin
        #Frontkiq::Web.tabs['Custom Tab'] = '/custom'
        #Frontkiq::Web.get('/custom') do
        #  t('translated_text')
        #end
